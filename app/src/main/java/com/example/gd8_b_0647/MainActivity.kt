package com.example.gd8_b_0647
...
import com.example.gd8_b_0647.adapters.MahasiswaAdapter
import com.example.gd8_b_0647.api.MahasiswaApi
import com.example.gd8_b_0647.models.Mahasiswa
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rvProduck = findViewById<RecyclerView>(R.id.rv_mahasiswa)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == LUNCH_ADD_ACTIVITY && resultCode == RESULT_OK) allMahasiswa()
    }
